...
if (status === "loading") {
return ( <div className="flex h-screen items-center justify-center bg-[#0B1120] text-white">
...
return ( <div className="flex flex-col items-center justify-center min-h-screen bg-[#0B1120] text-gray-100 px-4"> <div className="max-w-2xl w-full bg-[#0f1a30] p-10 rounded-2xl shadow-xl border border-[#1d2840]"> <h1 className="text-3xl font-bold text-[#00A8E8] text-center">
Arjun AI </h1> <p className="text-sm text-gray-400 text-center mb-8">
where prompts hit the target 🎯 </p>
